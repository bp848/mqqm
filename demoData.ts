...
export interface DemoDataState {
  ...
  titles: Title[]; // Added titles to DemoDataState
}
...
export const createDemoDataState = (): DemoDataState => {
  ...
  const leads: Lead[] = [
    {
      ...
      pageLoadTime: 1500,
      timeOnPage: 300,
      ctaSource: 'header_button',
      scrollDepth: '75%',
      sectionsViewed: 'pricing,features',
      printTypes: 'offset,digital',
      country: '日本',
      city: '横浜市',
      region: '神奈川県',
      employees: '120名',
    ...
    },
    {
      ...
      referrerUrl: 'https://www.google.com/search?q=採用パンフレット+印刷',
      ...
      pageLoadTime: 2000,
      timeOnPage: 600,
      ctaSource: 'hero_banner',
      scrollDepth: '90%',
      sectionsViewed: 'about,portfolio',
      printTypes: 'offset',
      country: '日本',
      city: '神戸市',
      region: '兵庫県',
  ...
  const employeeUsers: EmployeeUser[] = [
    {
      ...
      employeeNumber: 'E001',
      name: '田中 翔',
      departmentId: 'dept-001', // Assuming these IDs exist in `departments` table
      departmentName: '営業部',
      positionId: 'pos-001', // Assuming these IDs exist in `employee_titles` table
      positionName: 'マネージャー',
  ...
  // Added mock Department and Title data as per type definitions
  const departments: Department[] = [
    { id: 'dept-001', name: '営業部', createdAt: '2023-01-01T00:00:00Z' },
    { id: 'dept-002', name: '製造部', createdAt: '2023-01-01T00:00:00Z' },
    { id: 'dept-003', name: '経理部', createdAt: '2023-01-01T00:00:00Z' },
  ];

  const titles: Title[] = [
    { id: 'pos-001', name: 'マネージャー', isActive: true, createdAt: '2023-01-01T00:00:00Z' },
    { id: 'pos-002', name: 'シニアセールス', isActive: true, createdAt: '2023-01-01T00:00:00Z' },
    { id: 'pos-003', name: '工場長', isActive: true, createdAt: '2023-01-01T00:00:00Z' },
  ];
  ...
  return {
    ...
    departments,
    paymentRecipients,
    titles, // Added titles to the returned state
  };
};