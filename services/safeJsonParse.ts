 ...
 */
export function sanitizeLooseSemicolons(jsonLike: string): string {
 ...
 */
export function safeJsonParse<T>(jsonLike: string, options: SafeJsonParseOptions & { includeSanitized: true }): { value: T, sanitized: string };
export function safeJsonParse<T>(jsonLike: string, options?: SafeJsonParseOptions): T;
export function safeJsonParse<T>(jsonLike: string, options: SafeJsonParseOptions = {}): T | { value: T, sanitized: string } {
  ...
  try {
    ...
    const syntaxError = new SyntaxError(
      sanitize
        ...
        : error.message
    ) as SyntaxError & { cause?: any; sanitized?: string };
